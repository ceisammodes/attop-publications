...
The data are stored in `https://uncloud.univ-nantes.fr/index.php/apps/files/files/2479326929?dir=/ATTOP-TEAM/XYZ/doi.org--10.1021--acs.jctc.5c00110` and the repository has the following structure.
